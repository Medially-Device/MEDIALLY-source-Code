...
setup(
    ...
    entry_points={
        'console_scripts': [
'bluetooth_recorder_node = bluetooth_recorder.bluetooth_recorder_node:main',
'speech_to_text_node = bluetooth_recorder.speech_to_text_node:main',
...
'llm_service_sentence_node_v5 = bluetooth_recorder.LLM_service_node_v5:main',
...
'Patient_vectorization_node = bluetooth_recorder.vectorization_database_Patient_History:main',
...
'Dispenser_node_v3 = bluetooth_recorder.medication_dispense_v3:main',
